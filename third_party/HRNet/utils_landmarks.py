...
def show_landmarks(img, lmks, save_name=None, circle_size=1, color=(255, 0, 0), figsize=(10,8), is_copy=True):
    """
    Plot landmarks on image
    :param img: source image
    :param lmks: landmarks to chow
    :param save_name: if None show in windows, str save in file
