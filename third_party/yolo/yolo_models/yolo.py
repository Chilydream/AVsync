...
from yolo_models.common import Conv, Bottleneck, SPP, DWConv, Focus, BottleneckCSP, C3, Concat, NMS, autoShape, C4
...
from yolo_utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info
from yolo_utils.torch_utils import scale_img, initialize_weights, select_device, copy_attr
...
def parse_model(d, ch):  # model_dict, input_channels(3)
	...
	for i, (f, n, m, args) in enumerate(d['backbone']+d['head']):  # from, number, module, args
		...
		if m in [Conv, Bottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP, C3, C4]:
			c1, c2 = ch[f], args[0]
...
# print("Run 'tensorboard --logdir=yolo_models/runs' to view tensorboard at http://localhost:6006/")
