# Dataset yolo_utils and dataloaders
...
def extract_boxes(path='../coco128/'):  # from yolo_utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0)):  # from yolo_utils.datasets import *; autosplit('../coco128')
