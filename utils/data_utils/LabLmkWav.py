...
class LabLmkWavDataset(Dataset):
	def __init__(self, dataset_file, seq_len, max_size):
		super(LabLmkWavDataset, self).__init__()
...
class LabLmkWavDataLoader(DataLoader):
	def __init__(self, dataset_file, batch_size, num_workers, seq_len, is_train=True, max_size=0):
		...
		self.dataset = LabLmkWavDataset(dataset_file=dataset_file,
		                                seq_len=seq_len,
		                                max_size=max_size)
